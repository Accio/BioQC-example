...
~~~~
    ...
    ##  [1] highr_0.6            BiocInstaller_1.22.3 formatR_1.4         
    ##  [4] bitops_1.0-6         tools_3.3.1          digest_0.6.9        
    ##  [7] RSQLite_1.0.0        evaluate_0.9         gtable_0.2.0        
    ## [10] DBI_0.4-1            yaml_2.1.13          stringr_1.0.0       
    ## [13] httr_1.2.1           gtools_3.5.0         caTools_1.17.1      
    ## [16] grid_3.3.1           R6_2.1.2             XML_3.98-1.4        
    ## [19] rmarkdown_1.0        gdata_2.17.0         magrittr_1.5        
    ## [22] htmltools_0.3.5      KernSmooth_2.23-15   stringi_1.1.1       
    ## [25] RCurl_1.95-4.8
