...
The *BioQC* implementation is more than 500 times much faster (fig...): while it takes about one second for BioQC to calculate enrichment scores of all `r length(gmt)` signatures in 100 samples, the native R implementation takes about 20 minutes.
