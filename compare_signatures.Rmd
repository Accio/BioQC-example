...
jm=pairwiseJaccMat(gtex, gtex.gini, "GTEx limma", "GTEx gini")
glgg = make.plot(jm)
jm=pairwiseJaccMat(gtex, bioqc, "GTEx limma", "BioQC")
glbqc = make.plot(jm)
jm=pairwiseJaccMat(gtex.gini, bioqc, "GTEx gini", "BioQC")
gggbc = make.plot(jm)

pdf("fig/jaccard_gtex-limma_gtex-gini.pdf", width=10, height=12)
print(glgg)
dev.off()

pdf("fig/jaccard_gtex-limma_bioqc.pdf", width=10, height=35)
print(glbqc)
dev.off()

pdf("fig/jaccard_gtex-gini_bioqc.pdf", width=15, height=35)
print(gggbc)
dev.off()
